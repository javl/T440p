### Prevent USB wakeup ###
The laptop would sometimes wake itself up while closed and in my bag. Found out this was caused by a wakup signal coming from the USB controller.
No idea why this was happening, but an easy fix was to disallow the USB controller from waking up the computer:
...
```/etc/laptop-mode/conf.d/runtime-pm.conf```
    ...
    # A UTOSUSPEND_USE_WHITELIST=1 means AUTOSUSPEND_*_WHITELIST will be used.
    ...
    AUTOSUSPEND_RUNTIME_DEVID_BLACKLIST="045e:07a5"
